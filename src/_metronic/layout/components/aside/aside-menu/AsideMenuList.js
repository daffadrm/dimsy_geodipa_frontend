      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        >
          <NavLink className="menu-link" to="/user-profile">
            ...
            <span className="menu-text"><FormattedMessage id="TITLE.USER_PROFILE" /></span>
          </NavLink>
        </li>
        {/*end::1 Level*/}
        ...
        {/*begin::1 Level*/}
        <li
          className={`menu-item ${getMenuItemActive("/create-account", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/create-account">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl(
            ...
            <span className="menu-text">
              <FormattedMessage id="TITLE.CREATE_ACCOUNT" />
            </span>
          </NavLink>
        </li>
        {/*end::1 Level*/}
        ...
        {/*begin::1 Level*/}
        <li
          className={`menu-item ${getMenuItemActive("/user/delivery_monitoring", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/user/delivery_monitoring/dashboard">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl(
                  "/media/svg/icons/Map/Direction2.svg"
                )}
              />
            </span>
            <span className="menu-text">Delivery Monitoring</span>
          </NavLink>
        </li>
        {/*end::1 Level*/}
        ...
        {/*begin::1 Level*/}
        <li
          className={`menu-item ${getMenuItemActive("/vendor/deliverable_document", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/vendor/deliverable_document">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl(
            ...
            <span className="menu-text">Deliverable Document</span>
          </NavLink>
        </li>
        {/*end::1 Level*/}
